...
export const content = {
  welcome: {
    ...
    name: "Monica :)",
    message:
      "Aquí encuentras mi rinconcito de detalles virtuales para ti :D. Tómate tu tiempo, lee cada sección y continúa lentamente.",
    buttonText: "Comenzar",
  },
  letter: {
  ...
  finalMessage: {
    title: "Para terminar...",
    content:
      "Anhelo vivir momentos como estos por mucho tiempo, espero que tu también sientas lo mismo y que podamos ser twins por mucho tiempo más. \n\nTe adoro, Monica.",
